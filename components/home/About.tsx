    ...
    return (
        <div className="mt-[125px]">
            <div className="flex items-center gap-3 ">
                ...
                <h1 className="text-[40px] font-[700]  text-[#000] ">About Me </h1>
            </div>

            <div className="flex justify-between gap-[120px] mt-[96px]">

                <div>
                    <CustomImage src="/images/sam.png" alt="Ripple" width={2000} height={600} className="max-900:w-[80%]" />

                </div>

                <div className="text-[#000] text-[25px] font-[500]">
