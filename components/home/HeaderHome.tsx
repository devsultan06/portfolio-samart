            ...
            <div className="bg-[url('/images/bgm.png')] relative bg-center rounded-3xl bg-cover bg-no-repeat  block md:hidden h-[89vh]  bg-[#afafaf] font-inter">
                ...
                <div>
                    <div className="flex flex-col justify-center  h-[100vh] max-900:h-[60vh]">
                        <h1 className="text-[18px] mb-[20px] text-center mt-[100px] font-[700] text-white max-900:text-[30px] ">
                            Hello, I’m                    </h1>
                        <h1 className="text-[36px] mb-[20px] text-center font-shrikhand font-[400] name">
                            Ademola  Samuel
                        </h1>
                        <p className="text-[18px] font-[700] mb-[36px] text-center">
                            UI/UX Designer And Realistic Artist                    </p>
                        <p className="text-[16px] italic font-[300] text-center">Welcome to my portfolio where you get to see seamless
                            designs from my user experience / user interface skill
                            and amazing realistic pencil artwork and paintings</p>
                    </div>
                </div>
