...
const HeaderResume = () => {
    ...
    return (
        <div className="">
            ...
            <div className="bg-[url('/images/bg3m.png')] relative bg-center rounded-3xl bg-cover bg-no-repeat block md:hidden h-[89vh]  bg-[#afafaf] font-inter">
                ...
                <div>
                    <div className="flex flex-col  justify-center  h-[100vh] max-900:h-[60vh]">
                        ...
                        <p className="text-[24px] md:text-[36px] text-[#000] font-[500] text-center">Discover my value as a UI/UX designer by exploring my resume, which highlights my abilities, skills and achievements.  </p>
                    </div>
                </div>
