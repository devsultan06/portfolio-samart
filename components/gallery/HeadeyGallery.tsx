...
const HeaderGallery = () => {
    ...
    return (
        <div className="">
            <div className="bg-[url('/images/bg5.png')] relative rounded-3xl bg-cover hidden md:block    h-[120vh]  bg-[#afafaf] font-inter">
            ...
            <div className="bg-[url('/images/bg5m.png')] relative bg-center rounded-3xl bg-cover bg-no-repeat block md:hidden h-[89vh]  bg-[#afafaf] font-inter">
                ...
                <div className="flex px-[27px] pt-[19px]  items-center">
                    ...
                    <div className=" mx-auto">
                        <CustomImage src="/images/logo.png" alt="Ripple" width={150} height={50} className="" />
                    </div>
                ...
                <div>
                    <div className="flex flex-col text-[#fff] justify-center  h-[100vh] max-900:h-[60vh]">

                        <h1 className="text-[48px] md:text-[76px] font-[700] mb-[96px] text-center">
                            My Gallery
                        </h1>

                        <p className="text-[24px] md:text-[36px] font-[300] text-center">Step into my art gallery and discover a world of breathtaking pencil art and mural paintings that will leave you in awe.</p>
                    </div>
                </div>
