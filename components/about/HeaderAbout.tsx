...
const HeaderProject = () => {
    ...
    return (
        <div className="">
            ...
            <div className="bg-[url('/images/bg2m.png')] relative bg-center rounded-3xl bg-cover bg-no-repeat block md:hidden h-[89vh]  bg-[#afafaf] font-inter">
                ...
                <div>
                    <div className="flex flex-col  justify-center  h-[100vh] max-900:h-[60vh]">
                        ...
                        <h1 className="text-[48px] font-[700] mb-[96px] name2 text-center">
                            My Project
                        </h1>

                        <p className="text-[24px] font-[300] text-center">Get ready to be inspired! My project page features a curated selection of my best designs, showcasing my skills and expertise.</p>
                    </div>
                </div>
